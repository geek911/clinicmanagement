...
urlpatterns = [
    ...
    path('delete-doctor-from-clinic/<int:pk>', views.delete_doctor_from_hospital_view,
    ...
    path('delete-patient-from-clinic/<int:pk>', views.delete_patient_from_hospital_view,
         name='delete-patient-from-clinic'),
